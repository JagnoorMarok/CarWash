      ...
      <div className="footer-inner">
        <div className="footer-top">
          ...
          <div className="footer-brand">
            ...
            <p className="footer-tagline">“Detailing Done Right. Every Time.” Premium vehicle detailing proudly serving Surrey and the Lower Mainland.</p>
          ...
          <div className="footer-col">
            <h4>Contact</h4>
            <a href="tel:7786370025" className="footer-contact-item">
              <Phone size={14} />
              <span>(778) 637-0025</span>
            </a>
            <a href="mailto:primefinisha@gmail.com" className="footer-contact-item">
              <Mail size={14} />
